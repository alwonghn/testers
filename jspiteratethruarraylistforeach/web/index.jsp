<%--
    http://www.jsptutorial.net/jstl-looping-iteration-actions.aspx
http://www.jsptutorial.net/jstl-looping-iteration-actions.aspx
--%>
<%--copy from
    ...
    Author     : alfred.wong
--%>
<%@page contentType="text/html" pageEncoding="UTF-8" import="com.avms.jb.RoleBean,java.util.*,javax.naming.*,javax.sql.DataSource,java.sql.*"%>
...
<%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
 ...
 <%
    ...
    RoleBean rb1 = new RoleBean("inspector", "ticket inspection");
    RoleBean rb2 = new RoleBean("conductor", "bus conductor");
    alRoleBean.add(rb1);
    alRoleBean.add(rb2);
