 ...
 * @author alfred.wong
 */
public class ArraylistDifferencingUsingCollectionRemove {
    ...
    public static Collection<String> RemoveFromListA(Collection<String> icList, Collection<String> replList, Collection<String> topgList, Collection<String> botgList){
...
//    }
    ...
    public static void main(String[] args) {
        Collection<String> icList = new ArrayList<String> ();
        ...
        Collection<String> replList = new ArrayList<String> ();
        replList.add(new String("bbn1"));
        Collection<String> topgList = new ArrayList<String> ();
        topgList.add(new String("bbn3"));
        Collection<String> botgList = new ArrayList<String> ();
...
//        Collection<String> resultList = RemoveAllListBfromListA(icList, replList);
        ...
        Collection<String> resultList = RemoveFromListA(icList, replList, topgList, botgList);
