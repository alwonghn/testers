...
//    ArrayList<AlertQueList> AlertList = null;
...
//        loginPreferenceBean = loginCheckBean.getLogin_preference();
        loginPreferenceBean = Main.rif.getLoginPreference(110201);

        //System.out.println("Hello" + rif.getMessage());
...
//            txfLastITP.setText(String.valueOf(AlertList.get(alertQueTable.getSelectionModel().getLeadSelectionIndex()).getLastItp()));
...
//            txfVehStatus.setText(AlertList.get(alertQueTable.getSelectionModel().getLeadSelectionIndex()).getVehStatus());
...
//            txfCallStat.setText(AlertList.get(alertQueTable.getSelectionModel().getLeadSelectionIndex()).getCalStatus());
//            txfOrigSC.setText(AlertList.get(alertQueTable.getSelectionModel().getLeadSelectionIndex()).getOrigSc());
