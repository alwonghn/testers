...
//        add(mainContainer);
        ...
        LoginPreferenceBean loginPreferenceBean;
        ...
        System.out.println(" login preference - " + loginPreferenceBean.getGroup_id());
        System.out.println(" login preference - " + loginPreferenceBean.getUser_id());
        System.out.println(" login preference - " + loginPreferenceBean.getRoute_id());
