...
public class CurrentPerformanceStatusBean {
    ...
    public CurrentPerformanceStatusBean(){
        ...
        block_alpha_sort = 0;
        nonschedule = false;
        nonscheduleactive = false;
        reftime = tsDefaultDate;
        start_time = tsDefaultDate;
        sim_vehicle_id = 0;
        sim_operator_id = 0;
        yard_assignment_log_id = 0;
        run_id = 0;
        vehicle_id = 0;
        driver_id = 0;
        deviation = 0;
        ...
        incident_type = 0;
        priority = 0;
        sched_time = tsDefaultDate;
        incident_date_time = tsDefaultDate;
        current_route_id = 0;
        vehicle_division_id = 0;
        garage_id = 0;
        geo_area_id = 0;
        incident_details = "";
        trip_id = 0;
        ...
        passenger_count = 0;
        block_num = 0;
        block_start = tsDefaultDate;
        block_end = tsDefaultDate;
        sched_mod_id = 0;
        sched_mod_name = "";
    }
